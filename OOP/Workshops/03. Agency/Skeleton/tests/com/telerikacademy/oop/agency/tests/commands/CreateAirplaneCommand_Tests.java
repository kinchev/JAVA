...
import com.telerikacademy.oop.agency.commands.creation.CreateAirplaneCommand;
...
import static com.telerikacademy.oop.agency.commands.creation.CreateAirplaneCommand.EXPECTED_NUMBER_OF_ARGUMENTS;
import static com.telerikacademy.oop.agency.tests.utils.TestData.Train.VALID_PASSENGER_CAPACITY;
import static com.telerikacademy.oop.agency.tests.utils.TestData.Train.VALID_PRICE;

/**
 * CreateAirplaneCommand arguments: {{Passenger Capacity}} {{Price Per Kilometer}} {{Has Free Food}}
 */
public class CreateAirplaneCommand_Tests {
    ...
    public void execute_should_throwException_when_passedUnparsablePassengerCapacity() {
        // Arrange
        List<String> arguments = List.of("invalid", String.valueOf(VALID_PRICE), "true");
    ...
    public void execute_should_throwException_when_passedUnparsablePricePerKm() {
        // Arrange
        List<String> arguments = List.of(String.valueOf(VALID_PASSENGER_CAPACITY), "invalid", "true");
    ...
    public void execute_should_addNewAirplane_when_passedValidInput() {
        // Arrange
        List<String> arguments = List.of(String.valueOf(VALID_PASSENGER_CAPACITY), String.valueOf(VALID_PRICE), "true");
