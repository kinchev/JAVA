...
public class BeerServiceImpl implements BeerService {
    ...
    public static final String MODIFY_BEER_ERROR_MESSAGE = "Only owner or admin can modify a beer.";
    ...
    public void update(Beer beer, User user) {
        Beer beerToUpdate = repository.getById(beer.getId());
        if (!beerToUpdate.getCreatedBy().equals(user) && !user.isAdmin()) {
